    ...
    *,
    ...
    return "\n".join(
        [
            ...
            f"- analysis_mode: {packet.static_reasoning.get('analysis_mode', 'ast_lite') or 'ast_lite'}",
            f"- unknown_reason: {packet.static_reasoning.get('unknown_reason', '') or '(none)'}",
            f"- origin_analysis_mode: {packet.static_reasoning.get('origin_analysis_mode', 'ast_origin_primary') or 'ast_origin_primary'}",
