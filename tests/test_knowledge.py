...
def test_derive_facts_from_contracts_skips_shape_scoped_contracts_without_call_context() -> None:
    contracts = (
        FunctionContract(
            qualified_name="normalize_name",
            returns_non_nil=True,
...
def test_derive_facts_from_contracts_skips_root_scoped_contracts_without_call_context() -> None:
    contracts = (
        FunctionContract(
            qualified_name="normalize_name",
            returns_non_nil=True,
...
def test_derive_facts_from_contracts_skips_prefix_scoped_contracts_without_call_context() -> None:
    contracts = (
        FunctionContract(
            qualified_name="normalize_name",
            returns_non_nil=True,
...
def test_derive_facts_from_contracts_skips_access_path_scoped_contracts_without_call_context() -> None:
    contracts = (
        FunctionContract(
            qualified_name="normalize_name",
            returns_non_nil=True,
